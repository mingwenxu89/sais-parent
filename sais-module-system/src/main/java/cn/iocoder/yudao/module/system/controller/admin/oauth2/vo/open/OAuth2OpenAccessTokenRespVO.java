...
@Schema(description = "Management backend - [Open API] Access token Response VO")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OAuth2OpenAccessTokenRespVO {
    ...
    @Schema(description = "Authorization scope, if there are multiple authorization scopes, use spaces to separate them.", example = "user_info")

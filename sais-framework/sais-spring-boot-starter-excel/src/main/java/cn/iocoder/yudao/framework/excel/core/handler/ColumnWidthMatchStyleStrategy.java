...
/**
 * Excel adaptive column width processor
 *
 * Compared to {@link LongestMatchColumnWidthStyleStrategy}, the DATE type is additionally processed!
 *
 * @see <a href="https://github.com/YunaiV/yudao-cloud/pull/196/">Add an adaptive column width processor and replace the default column width policy</a>
 * @author hmb
 */

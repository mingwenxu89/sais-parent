...
public class YudaoApiLogAutoConfiguration implements WebMvcConfigurer {
 ...
 /**
     * Create APIAccessLogFilter Bean to record API request logs
 */
 @Bean
    @ConditionalOnProperty(prefix = "yudao.access-log", value = "enable", matchIfMissing = true) // Allow disabling access log using yudao.access-log.enable=false
